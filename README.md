# NEXUM Minimum Viable Product (MVP)

Questo repository contiene il Minimum Viable Product (MVP) per **NEXUM**, la piattaforma HR sviluppata da Eggon in collaborazione con UNIPD.

L'MVP si concentra su due ambiti funzionali principali:
...
## Cosa fa questo MVP
Questo MVP implementa due soluzioni AI avanzate per il contesto HR:
