...
class AiCopilotAnalysesDataManagerTest < ActiveSupport::TestCase
  setup do
    ...
    @up_doc_1 = UploadedDocument.create!(
      ...
      storage_path: "/fake/path/1.pdf", checksum: "hash123", # <- AGGIUNTI QUI
    ...
    @up_doc_2 = UploadedDocument.create!(
      ...
      storage_path: "/fake/path/2.pdf", checksum: "hash456", # <- AGGIUNTI QUI
    ...
    @up_doc_3 = UploadedDocument.create!(
      ...
      storage_path: "/fake/path/3.pdf", checksum: "hash789"  # <- AGGIUNTI QUI
    )
    ...
    @manager = AiCopilotAnalysesDataManager.new(start_date: 1.day.ago, end_date: 1.day.from_now)
  end
