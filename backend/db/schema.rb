...
ActiveRecord::Schema[8.1].define(version: 2026_03_30_123000) do
  ...
  create_table "styles", force: :cascade do |t|
    ...
    t.string "name", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id", "name"], name: "index_styles_on_company_id_and_name", unique: true
  ...
  create_table "tones", force: :cascade do |t|
    ...
    t.string "name", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id", "name"], name: "index_tones_on_company_id_and_name", unique: true
